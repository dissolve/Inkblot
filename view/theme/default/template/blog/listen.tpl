...
<div>
  ...
  <?php foreach($post['context'] as $ctx){ ?>
    ...
    <?php } ?>
          ...
          <article id="listen-<?php echo $post['post_id']?>" class="listen-<?php echo $post['post_id']?> listen type-listen status-publish format-standard category-uncategorized <?php echo ($post['draft'] == 1 ? 'draft':'') ?> <?php echo ($post['deleted'] == 1 ? 'deleted':'') ?>">
  ...
  <div class='articlebody'>
      ...
      <div class="entry-content e-content listen p-name">
