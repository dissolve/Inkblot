...
<div class="h-entry hentry">
  ...
  <?php foreach($post['context'] as $ctx){ ?>
    ...
    <?php } ?>
          ...
          <article id="video-<?php echo $post['post_id']?>" class="video-<?php echo $post['post_id']?> video type-video status-publish format-standard category-uncategorized <?php echo ($post['draft'] == 1 ? 'draft':'') ?> <?php echo ($post['deleted'] == 1 ? 'deleted':'') ?>">
  ...
  <div class='articlebody'>
    ...
    <?php } ?>
      <div class="entry-content e-content">
        <a href="<?php echo $post['image_file']?>" class="u-video video-post" >Link</a><br>
