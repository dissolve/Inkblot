  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-product">
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if (in_array($photos['photo_id'], $selected)) { ?>
		...
		<td class="text-left"><img src="<?php echo $photo['image_file']?>" class="photo-thumb" /></td>
                <td class="text-left"><?php echo $photo['title']; ?></td>
                <td class="text-left"><?php echo $photo['timestamp']; ?></td>
                <td class="text-right">
                <a href="<?php echo $photo['send_mention']; ?>" data-toggle="tooltip" title="Send Webmentions" class="btn btn-primary"><i class="fa fa-share"></i></a>
                <a href="<?php echo $photo['permalink']; ?>" data-toggle="tooltip" title="View Live" class="btn btn-primary"><i class="fa fa-link"></i></a>
                <a href="<?php echo $photo['view']; ?>" data-toggle="tooltip" title="View" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                <a href="<?php echo $photo['edit']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                </td>
              </tr>
              <?php } ?>
              <?php } else { ?>
