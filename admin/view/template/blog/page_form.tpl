  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-page" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn"><i class="fa fa-check-circle"></i></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-page" class="form-horizontal">
            <div class="content">
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="page[title]" value="<?php echo isset($page) ? $page['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title" class="form-control" />
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="page[slug]" value="<?php echo isset($page) ? $page['slug'] : ''; ?>" placeholder="<?php echo $entry_slug; ?>" id="input-slug" class="form-control" />
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <textarea name="page[body]" placeholder="Bost of Page" id="input-body" class="form-control"><?php echo isset($page['body']) ? $page['body'] : ''; ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="page[replyto]" value="<?php echo isset($page) ? $page['replyto'] : ''; ?>" placeholder="<?php echo $entry_replyto; ?>" id="input-replyto" class="form-control" />
