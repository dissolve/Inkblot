  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        ...
        <a href="<?php echo $photo['permalink']; ?>" data-toggle="tooltip" title="View Live" class="btn"><i class="fa fa-link"></i></a>
        <a href="<?php echo $photo['edit']; ?>" data-toggle="tooltip" title="Edit" class="btn"><i class="fa fa-pencil-square-o"></i></a>
