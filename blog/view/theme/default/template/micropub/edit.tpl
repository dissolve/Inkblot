<?php echo $header; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-post" class="form-horizontal">
        ...
        <script type="text/javascript" src="/blog/view/javascript/ckeditor/ckeditor.js"></script> 
                    ...
                    <!--<input type="radio" name="type" value="note" id="radio-note" <?php echo($type == 'note' ? '' :'checked')?> class="form-control" onclick="enableGroup('edit-note');" /> Note
                    <input type="radio" name="type" value="article" id="radio-article" <?php echo($type == 'article' ? 'checked':'')?> class="form-control" onclick="enableGroup('edit-article');" /> Article
                    <input type="radio" name="type" value="rsvp" id="radio-rsvp" <?php echo($type == 'rsvp' ? 'checked': '')?> class="form-control" onclick="enableGroup('edit-rsvp');" /> RSVP
                    <input type="radio" name="type" value="checkin" id="radio-checkin" <?php echo($type == 'checkin' ? 'checked': '')?> class="form-control" onclick="enableGroup('edit-checkin');" /> Checkin
                    <input type="radio" name="type" value="like" id="radio-like" <?php echo($type == 'like' ? 'checked': '')?> class="form-control" onclick="enableGroup('edit-like');" /> Like
                    <input type="radio" name="type" value="bookmark" id="radio-bookmark" <?php echo($type == 'bookmark' ? 'checked': '')?> class="form-control" onclick="enableGroup('edit-bookmark');" /> Bookmark-->
                  </div>
                </div>
            <div class="content">
            <div class="content">
