<?php echo $header; ?>
  ...
  <header class="entry-header">
    <h1 class="entry-title p-name" itemprop="name headline"><a href="<?php echo $photo['permalink']?>" class="u-url url" title="Permalink to <?php echo $photo['title']?>" rel="bookmark" itemprop="url"><?php echo $photo['title']?></a></h1>
      ...
      <span class="sep">Posted on </span>
        ...
        <?php if($photo['replyto']) { ?>
            <div class="repyto">
               In Reply To <a class="u-url" rel="in-reply-to" href="<?php echo $photo['replyto']?>">This</a>
            </div>
        <?php }  // end if replyto?>
        </div><!-- .entry-meta -->
      </header><!-- .entry-header -->
      ...
      <div class="entry-content e-content" itemprop="description articleBody">
        <img src="<?php echo $photo['image_file']?>" class="u-photo photo-post" />
