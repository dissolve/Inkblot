...
foreach($posts as $post) {
    $datapoints_array[] = '{ x: new Date('.$post['year'].', '.$post['month'].', '.$post['day'].'), y: '.$post['weight']['num'].', indexLabel: "'.$post['weight']['num']." " . $post['weight']['unit'].'", markerType: "circle",  markerColor: "#6B8E23", markerSize: 12}';
