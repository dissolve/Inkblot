...
class ControllerMicropubClient extends Controller {
    public function index()
    {
        ...
        if (isset($this->request->get['bookmark-of'])) {
            $data['post'] = array('bookmark-of' => $this->request->get['bookmark-of']);
        }
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/new')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/new', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/new', $data));
        }
    }
    public function contacts()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/contacts')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/contacts', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/contacts', $data));
        }
    }
    ...
    public function live()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/live')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/live', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/live', $data));
        }
    }
    public function note()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/note')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/note', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/note', $data));
        }
    }
    ...
    public function checkin()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/checkin')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/checkin', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/checkin', $data));
        }
    }
    ...
    public function editPost()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/edit')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/edit', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/edit', $data));
        }
    }
    ...
    public function deletePost()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/delete')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/delete', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/delete', $data));
        }
    }
    public function unDeletePost()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/micropub/undelete')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/micropub/undelete', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/micropub/undelete', $data));
        }
    }
    ...
    public function send()
    {
        ...
        } elseif (isset($this->request->post['inkblot-live'])) {
